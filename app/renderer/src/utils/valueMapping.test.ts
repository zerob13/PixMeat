...
describe('value mapping', () => {
  ...
  it('normalizes engine params', () => {
    const params = toEngineParams({
      ...
      liquify: { ...defaultParams.liquify, faceSlim: 30, eyeEnlarge: -20, chinLength: -25 },
    ...
    expect(params.liquify.eyeEnlarge).toBe(-0.2)
